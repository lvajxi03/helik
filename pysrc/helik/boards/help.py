...
class BoardHelp(Board):
    ...
    def on_paint(self):
        ...
        l, r = self.res_man.get_label(BoardType.HELP, "title-shadow", self.parent.lang)
        self.res_man.get("surfaces", "buffer").blit(l, (55, 45))
        l, r = self.res_man.get_label(BoardType.HELP, "title", self.parent.lang)
